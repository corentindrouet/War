...
_treat_file: ; void treat_file(char *name (rdi), long virus_size (rsi), char *full_path (rdx), bool fork (r10), long code_inc (r11))
	enter 152, 0 ; equal to push rbp - mov rbp, rsp - sub rsp, 16
	; rsp + 0 bytes for fd
...
; check if name != NULL
	...
	je _not_ok_end
; save parameters
	mov QWORD [rsp + 120], r11 ; code_inc
